        ...
        <div className="flex h-14 items-center justify-between px-4 md:px-6 max-w-7xl mx-auto">
          ...
          >
            <div className="relative">
              <div className="w-8 h-8 rounded-xl bg-primary flex items-center justify-center shadow-lg group-hover:scale-105 transition-transform duration-200">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <div className="p-1 rounded-lg text-muted-foreground/60 group-hover:text-foreground group-hover:bg-muted/50 transition-colors">
